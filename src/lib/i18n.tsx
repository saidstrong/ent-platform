...
const KZ: Dictionary = {
  ...
  ai: {
    ...
    hideCitations: "Сілтемелерді жасыру",
        addSources: "Дереккөз қосу",
    noSourcesSelected: "Дереккөз таңдалмады.",
    noSourcesAvailable: "Қолжетімді дереккөз жоқ.",
    done: "Дайын",
    modeLesson: "Сабақ",
    modeCourse: "Курс",
    modeQuiz: "Тест",
    modeAssignment: "Тапсырма",
    modePlatform: "Платформа",
    modeGeneral: "Жалпы",
    modeGrounded: "Негізделген",
    hintMode: "Көмек режимі қосылған",
    rename: "Қайта атау",
    delete: "Жою",
  ...
  aiAnalytics: {
    ...
    subtitle: "Көмекші тіркелулері (күн/ай)",
    totalRequests: "Жалпы сұрақтар",
    unsupportedRate: "Қолдау жоқ пайызы",
    byOutcome: "Нәтижелер бойынша",
    byMode: "Режим бойынша",
    topQuestions: "Топ сұрақтар",
    question: "Сұрақ (күн/ай)",
    count: "Саны",
    lastSeen: "Соңғы көрілген",
    days: "Күндер",
    lessonLabel: "Сабақ",
    allLessons: "Барлық сабақтар (курс бойынша)",
    noLessonsFound: "Бұл курс үшін сабақ табылмады.",
    lessonId: "Сабақ ID",
    lessonIdPlaceholder: "Сабақ ID енгізіңіз",
    scopeCourse: "Курс бойынша",
    scopeLesson: "Сабақ бойынша",
    refresh: "Жаңарту",
    loading: "Жүктелуде...",
    noData: "Деректер жоқ.",
